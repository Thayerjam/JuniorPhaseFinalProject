                ...
                students && students.length
                    ? students.map((student) => (
                        <div key={student.id}>
                            ...
                            <button type="button" onClick={() => handleUnregistered(student.id)}>Unregister Student</button>
                            <button type="button" onClick={() => handleRegistered(student.id)}>Register Student</button>
                        </div>
                    ))
